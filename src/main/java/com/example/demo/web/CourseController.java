...
import com.example.demo.metier.CourseService;
...
public class CourseController {
    ...
    public String getContacts(Model model,
        ...
        List<Courses> contacts = contactService.findAll(pageNumber, ROW_PER_PAGE);
    ...
    public String addContact(Model model,
            @ModelAttribute("contact") Courses contact) {        
        try {
            Courses newContact = contactService.save(contact);
